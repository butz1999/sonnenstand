...
* Die Webseite hat drei Bereiche:
  * Titelbereich
    * Titel rechtsbündig
    * Zahnrad Symbol linksbündig
  * Grafik
  * Legende

### Zum Testen habe ich folgende zusätzlichen Anforderungen:
...
* Als Testfunktionalität gibt es:
  ...
  * Simulation mit einer Funktionalität der Auswahl eines alternativen Standortes. Die Standortauswahl soll im Klartext sein und bei dessen Auswahl in geografische Koordinaten umgerechnet wird.
